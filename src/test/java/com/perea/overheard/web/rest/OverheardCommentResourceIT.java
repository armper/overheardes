...
import com.perea.overheard.OverheardesApp;
...
import com.perea.overheard.repository.search.OverheardCommentSearchRepository;
 ...
 */
@SpringBootTest(classes = OverheardesApp.class)
public class OverheardCommentResourceIT {
    ...
    /**
     * This repository is mocked in the com.perea.overheard.repository.search test package.
     *
     * @see com.perea.overheard.repository.search.OverheardCommentSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void updateOverheardComment() throws Exception {
        ...
        reset(mockOverheardCommentSearchRepository);
